...
@Command(name="end", mixinStandardHelpOptions = true)
public class ConsumerPositionsEndCommand implements Runnable {

    private static final Logger LOG = Logger.getLogger(ConsumerPositionsEndCommand.class);
    ...
    public void run() {
        try {
            ...
            kafkaBridgeServiceFactory.getKafkaBridgeService().createConsumerPositionsEnd(groupId, consumerName, body);
        } catch (Exception e) {
